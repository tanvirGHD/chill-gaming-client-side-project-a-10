...
//     handleGoogleLogin()
//       .then(() => {
//         navigate("/"); // Google login successful, navigate to home page
//       })
//       .catch((error) => {
...
//             className="flex  items-center justify-center border text-green-600 py-2 px-4 rounded-lg font-bold space-y-2"
//           >
//             <img
//               className="h-8 w-8"
